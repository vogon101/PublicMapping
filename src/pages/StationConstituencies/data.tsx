...
export interface Constituency {
    ...
    PCON24NM: string;
    winningParty: string;
    mpFullName: string; // New combined field
    ratio800: number;
    ratio1000: number;
    ratio1200: number;
    ratio1500: number;
...
export const loadConstituencies = async (): Promise<Constituency[]> => {
    const csvModule = await import('@/assets/data/constituency_station_overlap_with_results.csv?url');
    const csvUrl = csvModule.default;
