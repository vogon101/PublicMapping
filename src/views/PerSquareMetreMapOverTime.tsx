...
function PerSquareMetreMapOverTime() {
    ...
    return (
        ...
        >
            <Image src="/logo_colour_tight.png" alt="Logo" width={200} height={50} className="absolute bottom-12 left-2.5 md:bottom-2.5 max-w-[30%] max-h-[8vh] opacity-40 z-[1000] transition-all duration-300 ease-in-out rounded-[10px] p-[2vh] bg-white" />
